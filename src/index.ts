...
import { handleFalVideoJob } from './workers/fal-handlers.js';
...
const ltxI2VQueue = new Queue('ltxi2v', {
  connection: redisClient,
  streams: {
    events: {
      maxLen: 100,
...
const nvidiaVsrQueue = new Queue('nvidiavsr', {
  connection: redisClient,
  streams: {
    events: {
      maxLen: 100,
...
const falVideoQueue = new Queue('falvideo', {
  connection: redisClient,
  streams: {
    events: {
      maxLen: 100,
